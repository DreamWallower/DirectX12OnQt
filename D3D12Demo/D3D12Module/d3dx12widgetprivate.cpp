...
D3DX12WidgetPrivate *D3DX12WidgetPrivate::LoadAssets()
{
    ...
    // Create the pipeline state, which includes compiling and loading shaders.
    {
        ...
        // TODO: read hlsl file,  using m_assetsPath.
        LPCWSTR AssetPath = L"E:/_Fang/reposQt/D3D12/D3D12Demo/D3D12Module/shaders.hlsl";
        ThrowIfFailed(D3DCompileFromFile(AssetPath, nullptr, nullptr, "VSMain", "vs_5_0", compileFlags, 0, &vertexShader, nullptr));
        ThrowIfFailed(D3DCompileFromFile(AssetPath, nullptr, nullptr, "PSMain", "ps_5_0", compileFlags, 0, &pixelShader, nullptr));
